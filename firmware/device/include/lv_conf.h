...
#define LV_USE_DRAW_SW 1
     ...
     * Incoming-page / game chrome use radial washes (match PC sim lv_conf). */
...
/* shared UI uses display/body fallbacks at these sizes */
...
/* LODEPNG off — emojis are baked RGB565 in flash (see bake_emoji_assets.py). */
