...
constexpr size_t kC4DropSize = kPeerHdrSize + 3;            /* 28 */
constexpr size_t kStttMoveSize = kPeerHdrSize + 3;          /* 29 */
constexpr size_t kCkMoveSize = kPeerHdrSize + 4;            /* 30 */
constexpr size_t kMemInviteSize = kPeerHdrSize + 5;         /* 31 seed+first */
constexpr size_t kInviteFirstSize = kPeerHdrSize + 1;       /* 27 first flag */
constexpr size_t kC4InviteSize = kPeerHdrSize + 2;          /* 28 color+first */
constexpr size_t kC4AcceptSize = kPeerHdrSize + 1;          /* 27 color */
constexpr size_t kMemFlipSize = kPeerHdrSize + 3;           /* 28 */
